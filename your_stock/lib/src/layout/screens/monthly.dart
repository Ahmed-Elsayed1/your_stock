import '../../../../../packages/common/lib/src/features/app_cubit/charts_cubit/chart_cubit.dart';
...
class MonthlyChartScreenDesign extends StatelessWidget {
  final String symbol;

  const MonthlyChartScreenDesign({super.key, required this.symbol});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => StocksCubit(symbol)..getDataMonthly(),
