...
class MonthlyStockDetailsChartWidget extends StatelessWidget {
  final String symbol;

  const MonthlyStockDetailsChartWidget({super.key, required this.symbol});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => StockDetailsCubit(symbol)..getDataMonthly(),
